...
$Button15.Add_Click({
	...
	$EntryVariable = "ComboBox1","NumberBox1","NumberBox3","NumberBox2","Checkbox5","GenerateSettingsLoad2","strChars","transcode","strlengthmax","GetRandom","CheckBoxesCount","GenerateRandomString","GeneratePassword","eachpartchars","Form4","RadioButton1","ProgressBar1"
